...
export const action: ActionFunction = async ({ request }) => {
  ...
  if (step === "1") {
    ...
    return {
      ...
      script: `Hey there! 👋 Let's talk about speed limits in a way that actually makes sense!
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <Form method="post" className="space-y-6" encType="multipart/form-data">
        <div className={`flex gap-8 ${hasResult ? 'justify-between' : 'justify-center'}`}>
          <motion.div className="w-md flex-col flex gap-3" >
            <input type="hidden" name="step" value={hasResult ? "2" : "1"} />
